...
| `ROOM-28` | `contracts/VoiceRecording.md`, `contracts/HostConsole.md`, `contracts/AudioMixer.md` | `DATA-SCHEMA.md §1.11 recordings(kind)`, `specs/SecurityPolicies.md §11.1.1`, `API-SURFACE.md (start-room-recording)` | 계약 있음. ROOM-13 의 산출물 변형 — 상태기계·동의·보존 신규 없음 |
