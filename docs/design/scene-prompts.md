...
| `eastern-plaza-1` | **동양(eastern) 월드 광장 허브** — 밤 범동양 홍등 광장, 가게 7 식별(쌍가면 대극장·드레스폼 의상실·셔터 예비점포·대계단 회관·망치모루 공방·찻잔 다관·목조 무대), 무글자·무인물·발광 잉어/고래·풍등·보름달 | eastern | **생성·배선 완료(2026-07-31)** — edits+**eastern_splash 레퍼런스**(화풍 고정)·gpt-image-2 175s → **fal ESRGAN 2x(2026-08-02) → 3072×2048 WebP 1.15MB** `lobby-plaza/eastern-plaza-1.webp`(서양 세트와 규격 동일, 확대 QA 클린). EASTERN Composition 자체 캘리브(가게 7·홍등 9·하늘 밴드, 원화 오버레이+실렌더 호버 검증) + `plazaMood:'night'` → `.hub-cloud--night`(screen, 픽셀 diff Δ16.6≈낮 프리셋 동급). 프롬프트 원문 아래 §eastern |
| `eastern-interiors` | 동양 내부 4관 — theater(포스터 벽+홍커튼 매표소)·workshop(작업대+가면 스탠드)·teahouse(좌하/우하 테이블+방석)·atelier(대형 거울+한복 랙) | eastern | **생성·배선 완료(2026-07-31)** — 4장 병렬(147~187s) → **fal ESRGAN 2x(2026-08-02) → 3072×2048 WebP 757KB~1.0MB** `lobby-interiors/eastern-{theater,workshop,teahouse,atelier}.webp`, interiorAnchors 오버레이 캘리브(기존 앵커 키 유지 — 소비자 무변경). 실렌더 4관+거울 프리뷰 정박 확인 |
| `eastern-enter` | 동양 입장 영상 — eastern_splash i2v(풍등 상승·잉어 유영·용 전진·카메라 슬로우 푸시) | eastern | **완료(2026-07-31)** — Seedance 2.0 fast(5s·720p·무음·점진 시작) 141s → Topaz 2x+48fps($0.40) 49s → 2560×1440 → VP9 crf45 **2.3MB** `login-splash/eastern-enter.webm`. 프레임 실검증(0s=원화·중반 모션·화풍 보존)·실재생·introSeen 2회차 미재생 E2E. mp4 마스터 `v2/video/` |
...
| `theater-stage` | 방 무대 배경 — **무대 전용 대극장**(객석 최전열 시점 빈 무대·풋라이트·성좌 배경막). stageBackgrounds 'theater' 가 로비 매표소 원화를 재사용하던 "무대 전용 아트는 후속" 부채(F-8) 해소용 | western | **생성·채택 완료(2026-07-13)** — 화풍고정 edits, gpt-image-2 세이프티 오탐 400→gpt-image-1 폴백 66s. 계보 `~/Documents/채터박스/v2/masters/theater_stage_v1.png` → `public/scenes/room-stage/theater-stage.webp`(295KB, stageBackgrounds 'theater' 교체) |
...
#### eastern 월드 프롬프트 원문 (2026-07-31 생성 완료분 — 재생성용 보관)

공통 조립: `images/edits` + 레퍼런스 `~/Documents/채터박스/v2/masters/eastern_splash.png`, 프리픽스 "Using the exact same painting style, color palette, lighting and level of painterly detail as this reference artwork, paint a different scene from the same world:" + 본문 + ANCHOR v2 + `wide 16:9 composition`. 용은 밤 로그인 전용이라 광장·내부 프롬프트에 부재(영상에만 등장).

- **eastern-plaza-1**: `A pan-Asian fantasy lantern plaza at night, no people, seen at eye level across a stone-paved square, a blend of Korean, Japanese and Chinese architecture with upturned tiled eaves and dark wooden beams, glowing red and gold paper lanterns strung between the buildings; distinct storefronts around the plaza: a grand theater with a sweeping tiled roof, red curtained entrance and a hanging emblem of twin theater masks; beside it an elegant clothing shop with a dress-form mannequin glowing in its warm window; a small dark shuttered stall with no signboard; a stately guild hall with a wide stone staircase and hanging banners; a craftsman's workshop with a hammer-and-anvil emblem and warm forge light; a cozy teahouse with a teacup emblem and steam drifting from its window; and an open-sided wooden pavilion stage at the plaza edge; all signboards show simple painted symbols only - no letters, no writing anywhere; a small glowing koi pond in the middle of the square; the starry night sky above is a luminous ocean - faintly bioluminescent koi fish and a whale drifting among moonlit clouds, floating sky lanterns rising toward a full moon; deep blue-violet palette with warm red-gold lantern light`
- **eastern-theater**: `Inside the grand eastern theater's lantern-lit lobby at night, no people, warm wooden interior with tall red pillars and upturned-eave detailing, glowing paper lanterns hanging from the beams; on the left wall a large wooden notice board holding several framed performance posters with simple painted imagery and no letters; on the right a wooden ticket booth counter with a small warm lamp and a red hanging curtain; patterned stone floor, deep blue-violet night glimpsed through a latticed window, warm red-gold lantern light, no letters or writing anywhere`
- **eastern-workshop**: `Inside a cozy eastern craftsman's workshop at night, no people, warm wooden interior with glowing paper lanterns and hanging tools, shelves stacked with paper, silk and lantern frames; a large sturdy wooden workbench in the center foreground covered with brushes, ink stones and half-finished paper lanterns; behind the bench a wooden artisan's stand holding a half-painted festival mask; latticed windows showing the deep blue-violet night, warm red-gold lantern light, no letters or writing anywhere`
- **eastern-teahouse**: `Inside a warm eastern teahouse at night, no people, low wooden ceiling with glowing paper lanterns, latticed windows with the deep blue-violet night outside; two low wooden tea tables with floor cushions - one in the lower left, one in the lower right - each set with a teapot and cups, gentle steam rising; a small counter with tea jars at the back, a potted orchid, hanging fabric banners with simple painted symbols and no letters; warm red-gold lantern light`
- **eastern-atelier**: `Inside an elegant eastern clothing atelier at night, no people, warm wooden interior with glowing paper lanterns; a tall full-length mirror with an ornate carved wooden frame standing slightly right of center; hanbok-style silk robes displayed on wooden stands along the walls, rolls of colorful silk and an embroidery table; latticed windows with the deep blue-violet night, warm red-gold lantern light, no letters or writing anywhere`
- **eastern-enter (i2v)**: `The still painting comes alive. The motion begins almost imperceptibly - the first moments are nearly still, then the paper sky lanterns drift slowly upward and flicker warmly, the luminous koi fish glide gently among the moonlit clouds, the great glowing dragon swims slowly forward through the starry sky, the blossom petals and the hem of the woman's dress sway faintly in the night breeze, and the camera pushes forward very slowly over the lantern-lit city toward the full moon. One continuous slow forward camera move - no cuts, no shake. The figure remains still. Preserve the exact painting style.`
