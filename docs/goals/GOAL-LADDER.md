...
| G6 | U-무대몰입 | U-2 BGM(3곡 순환·배경 디커플·자동재생 0.25)+SFX 3계열 → U-1 파티클+배경 바람 모션 | 실렌더 + reduced-motion 가드 + autoplay 게이트 실측 | **BUILT**(2026-07-13: BGM 3곡 순환+SFX 4종($0.84)+GlowMotes preset+바람 팬 — check:all 그린(137/137)·실렌더 E2E **15/15**(게이트 시뮬·슬라이더·SFX 릴레이 3계열·파티클 픽셀·reduced-motion 2종·360px 482≤511). 배포 대기 — bepo 시 DONE) |
