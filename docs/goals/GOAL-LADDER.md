...
| G4 | V-10 자막편집(더빙) | STT 세그먼트 편집 UI→합성 산출물 자막 반영 | 통합 + 산출물 실측(vtt/번인 ffprobe) | BUILT — 통합 10/10·E2E 11/11(실 wasm 산출 mov_text+편집 텍스트 ffprobe 실측)·**배포 대기**(Edge 1+프론트, 프로드 클릭스루=bepo) |
