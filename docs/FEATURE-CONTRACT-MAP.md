...
| `ROOM-05`, `ROOM-06`, `ROOM-07`, `ROOM-08`, `ROOM-09` | `contracts/HostConsole.md`, `contracts/ScriptPanel.md`, `contracts/TimedTurnsProgressBar.md` | `state-machines/HostAuthority.md`, `state-machines/Script.md`, `DATA-SCHEMA.md §scripts` | 계약 있음 |
...
| `ROOM-19` | `contracts/ChatPanel.md`, `contracts/ChatOverlay.md` | `DATA-SCHEMA.md §messages`, `contracts/_INDEX.md DataChannel 타입 레지스트리`, `RUNTIME-HARDENING-REVIEW.md H13` | 계약 있음. `chat` 채널 `message_type='reaction'`, TTL/화이트리스트 필수 |
...
| `DUB-01`, `DUB-01b`, `DUB-02`, `DUB-03`, `DUB-04`, `DUB-05` | `contracts/DubSessionSelector.md`, `contracts/DubRoleAssigner.md`, `contracts/DubRecorder.md`, `contracts/DubCompositor.md`, `contracts/RightPanel.md` | `DATA-SCHEMA.md §1.12-1.14`, `state-machines/DubSession.md`, `specs/SecurityPolicies.md §2.2` | 계약 있음. DUB 5개 기능 + 4개 계약서 + DubSession FSM 완성 |
