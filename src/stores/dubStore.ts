...
interface DubStore {
  ...
  setRec: (p: Partial<Pick<DubStore, 'recTrackId' | 'recPreview' | 'recBusy' | 'recCalMs' | 'recMicStream' | 'recError'>>) => void
